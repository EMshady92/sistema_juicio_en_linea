            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="/terceras_personas">Terceros intereaados</a></li>
                        <li class="breadcrumb-item active">Detalles de terceros interesados</li>
                    </ol>
                </div>
                <h4 class="page-title">Detalles de: {{$tercera->nombre}} {{$tercera->apellido_paterno}}
                    {{$tercera->apellido_materno}} {{$tercera->razon_social}}. </h4>
                <div class="row">
                    <div class="col-6">
