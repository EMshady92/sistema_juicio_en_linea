            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Edición tipos de Acuerdos</li>
                    </ol>
                </div>
                <h4 class="page-title">Editar Acuerdo</h4>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div>
                            ...
                            <p class="sub-header">
                                Formulario para editar : {{$acuerdo->tipo}} 
                            .
                            </p>
                            ...
                            <form action="{{url('/acuerdos_tipos', [$acuerdo->id])}}" id="formulario" method="post" class="form-horizontal parsley-examples" enctype="multipart/form-data" accept-charset="UTF-8" >
                            {{csrf_field()}}
                            ...
                            <div class="form-group" >
                                    ...
                                    <input type="text" name="tipo"  parsley-trigger="change" required onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()"
                                     value="{{$acuerdo->tipo}}" class="form-control" id="tipo">
                            </div>
                        </div>
