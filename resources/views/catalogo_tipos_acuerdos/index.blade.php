            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="/acuerdos_tipos">Tipos de Acuerdos</a></li>
                        <li class="breadcrumb-item active">Listado de Tipos Acuerdos</li>
                    </ol>
                </div>
                <h4 class="page-title">Catálogo de Acuerdos</h4>
                <a href="/acuerdos_tipos/create" class="button-list">
        ...
        <div class="col-12">
            <div class="card-box">
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tbody>
                        @foreach($catalogos as $tipo)
                        <tr>
                            <td>{{$tipo->tipo}}</td>
                            
                           
                            
                            <td> <a href="{{URL::action('CatalogoTiposAcuerdosController@edit',$tipo->id)}}"
                            ...
                            <a class="btn waves-effect waves-light btn-warning" onclick=inactivar('{{$tipo->id}}','acuerdos_tipos');
