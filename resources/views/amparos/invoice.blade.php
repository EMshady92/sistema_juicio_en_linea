...
<body id="img_marca_agua">
    ...
    <main>
        <div>
            ...
            <h2><b>Acuse de {{$amparo->tipo}}<br>
                    Oficialia de Partes<br>
					N° de expediente relacionado: {{$datos->num_expediente}}</b></h2>
					<br><br>
			<h2> Por medio de la presente, se hace constar, que se recibio @if($amparo->tipo=="AMPARO") un {{$amparo->tipo}} relacionado @else una
                    {{$amparo->tipo}} relacionada @endif al número de expediente <b> {{$datos->num_expediente}}</b> "texto por definir......................................................."</b>
		 el cual contiene <b>{{$amparo->num_anexos}}</b> anexos, y <b>{{$amparo->hojas_escrito}}</b> hoja(s) de escrito. </h2>
		</div>
		<br><br>
