            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="/abogados">Usuarios</a></li>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div>
                            ...
                            <p class="sub-header">
                            Formulario para editar : {{$usuario->name}} {{$usuario->apellido_p}} {{$usuario->apellido_m}} {{$usuario->email}} .
                            </p>




                            <form action="{{url('/users', [$usuario->id])}}" method="post" class="form-horizontal parsley-examples" enctype="multipart/form-data" accept-charset="UTF-8" >
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="text" name="nombre"
                                        ...
                                        parsley-trigger="change" value="{{$usuario->name}}" placeholder="Ingresar el nombre" required
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="apellido_p"
                                        onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()"
                                        onkeypress="return soloLetras(event)" maxlength="30" minlength="1"
                                        parsley-trigger="change" value="{{$usuario->apellido_p}}" placeholder="Ingresar el apellido paterno" required
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="apellido_m"
                                        onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()"
                                        onkeypress="return soloLetras(event)" maxlength="30" minlength="1"
                                        parsley-trigger="change" value="{{$usuario->apellido_m}}" placeholder="Ingresar el apellido materno" 
