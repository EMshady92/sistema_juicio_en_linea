<div class="modal fade" id="modal_passRec" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="javascript:validaPasswordRecepcion();" id="formulario_pass_rec" name="formulario_pass_rec" >
