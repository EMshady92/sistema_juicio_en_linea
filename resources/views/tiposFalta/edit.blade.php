                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div>
                            ...
                            <p class="sub-header">
                                Formulario para editar : {{$tipo->tipo_falta}} 
                            .
                            </p>
                            ...
                            <form action="{{url('/tiposFalta', [$tipo->id])}}" id="formulario" method="post" class="form-horizontal parsley-examples" enctype="multipart/form-data" accept-charset="UTF-8" >
                            {{csrf_field()}}
                            ...
                            <div class="form-group" >
                                    ...
                                    <input type="text" name="tipo"  parsley-trigger="change" required onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()"
                                     value="{{$tipo->tipo_falta}}" class="form-control" id="tipo">
                            </div>
                        </div>
