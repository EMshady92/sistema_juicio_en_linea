            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="/tiposFalta">Tipos de falta</a></li>
                        <li class="breadcrumb-item active">Listado de tipos falta</li>
                    </ol>
                </div>
                <h4 class="page-title">Catálogo de tipos de falta</h4>
                <a href="/tiposFalta/create" class="button-list">
            ...
            <div class="card-box">
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$tipo->tipo_falta}}</td>
                            
                           
                            
                            <td> <a href="{{URL::action('tipoFaltaController@edit',$tipo->id)}}"
                            ...
                            <a class="btn waves-effect waves-light btn-warning" onclick=inactivar('{{$tipo->id}}','tiposFalta');
