            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Detalles de autoridades</li>
                    </ol>
                </div>
                <h4 class="page-title">Detalles de: {{$demandado->nombre}} . </h4>
                <div class="row">
                    <div class="col-6">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card-box">
                    ...
                    @if($expedientes)
                    <p class="sub-header">
                                Formulario que muestra todos los expedientes en lo que aparece la autoridad demandada .
                            </p>
                    <div class="table-responsive">
