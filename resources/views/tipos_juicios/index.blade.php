            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="/tipos_juicios">Tipos de Juicios</a></li>
                        <li class="breadcrumb-item active">Listado de Tipos Juicios</li>
                    </ol>
                </div>
                <h4 class="page-title">Catálogo de Juicios</h4>
                <a href="/tipos_juicios/create" class="button-list">
        ...
        <div class="col-12">
            <div class="card-box">
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tbody>
                        @foreach($juicios as $tipo)
                        <tr>
                            <td>{{$tipo->tipo}}</td>
                            
                           
                            
                            <td> <a href="{{URL::action('TiposJuiciosController@edit',$tipo->id)}}"
