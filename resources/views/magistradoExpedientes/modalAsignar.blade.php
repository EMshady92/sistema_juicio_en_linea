<div class="modal fade bs-example-modal-xl" id="modalAsignar" tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Listado de expedientes pendientes por asignar</h5>
                        ...
                        <div class="card-box">                         
                            <table id="key-table" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    ...
                                    @if($expediente->estado == "POR_ASIGNAR")                               
                                    <tr>
